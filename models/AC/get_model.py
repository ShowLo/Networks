...
def get_model(args):
    if args.model.lower() == 'mobilenetv3-large':
        ...
        return MobileNetV3(mode='small', classes_num=args.num_classes, input_size=args.input_size, width_multiplier=args.wd) 
    # ResNet for ImageNet
    ...
    # EfficientNet
        ...
        return EfficientNet(mode='b0', num_classes=args.num_classes, input_size=args.input_size, 
                            width_multiplier=args.width_multiplier, deploy=args.deploy)
    else:
