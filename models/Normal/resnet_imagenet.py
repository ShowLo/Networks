...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn2 = nn.BatchNorm2d(num_features=planes)#nn.Sequential(OrderedDict([('lastBN', nn.BatchNorm2d(num_features=planes))]))
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        #nn.Sequential(OrderedDict([('lastBN', nn.BatchNorm2d(num_features=self.expansion*planes))]))
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, width_multiplier=1.0):
...
def ResNet18(args):
    return ResNet(BasicBlock, [2, 2, 2, 2], args.num_classes, args.width_multiplier)


def ResNet34(args):
    return ResNet(BasicBlock, [3, 4, 6, 3], args.num_classes, args.width_multiplier)


def ResNet50(args):
    return ResNet(Bottleneck, [3, 4, 6, 3], args.num_classes, args.width_multiplier)


def ResNet101(args):
    return ResNet(Bottleneck, [3, 4, 23, 3], args.num_classes, args.width_multiplier)


def ResNet152(args):
    return ResNet(Bottleneck, [3, 8, 36, 3], args.num_classes, args.width_multiplier)